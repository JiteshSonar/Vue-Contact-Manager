        ...
        <div class="row">
            <div class="col-md-4">
                <form @submit.prevent="submitCreate()">
                    ...
                    <div class="mb-2">
                        <input required v-model="contact.phone" type="number" class="form-control" placeholder="Mobile">
                    </div>
                    <div class="mb-2">
...
export default {
    ...
    methods : {
        async submitCreate() {
            try {
                let createContact = await ContactService.createContact(this.contact);
                if (createContact){
